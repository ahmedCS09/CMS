        ...
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] border border-slate-700/50 p-10 shadow-2xl shadow-black/80">
          ...
          {success ? (
            <div className="text-center space-y-8 animate-in slide-in-from-bottom-4 duration-500">
              <div className="inline-flex items-center justify-center p-6 bg-green-500/10 text-green-400 rounded-[2rem] shadow-inner ring-4 ring-green-500/10">
                <CheckCircle2 size={48} strokeWidth={2.5} />
              </div>
              <div className="space-y-2">
                <h1 className="text-3xl font-black text-white tracking-tighter">Password Updated!</h1>
              ...
              <div className="pt-4">
                <Link
                  href="/auth/loginPage"
                  className="inline-flex items-center gap-2 bg-indigo-600 text-white px-8 py-4 rounded-2xl font-black text-lg hover:bg-indigo-700 transition-all shadow-xl shadow-black/40"
                >
                  Sign In Now
                  <ArrowRight size={20} />
                </Link>
            ...
            <>
              <div className="text-center mb-10">
                ...
                <h1 className="text-3xl font-black text-white tracking-tighter mb-2">Set New Password</h1>
                <p className="text-slate-400 font-semibold leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-indigo-600 text-white rounded-[1.5rem] py-4.5 font-black text-lg transition-all hover:bg-indigo-700 hover:shadow-2xl hover:shadow-indigo-500/20 active:scale-95 disabled:opacity-70 shadow-lg shadow-black/40"
                >
                  {loading ? (
